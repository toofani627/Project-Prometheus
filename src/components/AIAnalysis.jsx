        ...
        <footer className="border-t border-neo-cream/20 py-6 mt-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center md:justify-end">
              <span className="font-body text-neo-cream/40 text-sm uppercase">DEVELOPED BY</span>

              {/* Shashank (toofani627) — first, with GitHub link on hover */}
              <a
                href="https://github.com/toofani627"
                target="_blank"
                rel="noopener noreferrer"
                title="Visit toofani627 on GitHub"
                className="group relative flex items-center gap-2 px-3 py-1.5 rounded-full border border-neo-cream/40 hover:border-neo-cream transition-all duration-200 no-underline"
              >
                <img
                  src="/toofani-logo.png"
                  alt="Shashank"
                  className="w-6 h-6 rounded-full object-cover ring-1 ring-neo-cream/30 group-hover:ring-neo-cream transition-all"
                />
                <span className="font-subheading font-semibold text-neo-cream text-sm uppercase">SHASHANK</span>
                {/* GitHub icon — appears on hover */}
                <svg
                  className="w-3.5 h-3.5 text-neo-cream/0 group-hover:text-neo-cream/70 transition-all duration-200 ml-0.5"
                ...
                {/* Tooltip */}
                <span className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap bg-neo-dark border border-neo-cream/30 text-neo-cream/80 text-[10px] font-mono px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                  github.com/toofani627
                </span>
              </a>

              {/* Aradhy Shukla */}
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-neo-cream/30 hover:border-neo-cream transition-all duration-200">
                <img
                  src="/cloud-balloon-logo.png"
                  alt="Aradhy Shukla"
                  className="w-6 h-6 rounded-full object-cover ring-1 ring-neo-cream/20"
                />
